...
export const translations = {
  nb: {
    ...
    products: {
      ...
      ctaLabel: 'Sikre deg early bird-plass',
      gels: [
        {
          name: 'Tee Off',
          timing: 'Før runden',
    ...
    waitlist: {
      ...
      painPointLegend: 'Hva er din største utfordring på banen?',
      painPointOptions: [
        { value: 'fatigue', label: 'Energi og utmattelse – slites ut på back 9' },
        { value: 'focus', label: 'Konsentrasjon – mister fokus på de avgjørende hullene' },
        { value: 'nutrition', label: 'Ernæring generelt – usikker på hva jeg bør gjøre' },
      ],
      submitLabel: 'Sikre meg early bird-plass',
  ...
  en: {
    ...
    products: {
      ...
      ctaLabel: 'Secure your early bird spot',
      gels: [
        {
          name: 'Tee Off',
    ...
    waitlist: {
      ...
      painPointLegend: 'What is your biggest challenge on the course?',
      painPointOptions: [
        { value: 'fatigue', label: 'Energy and fatigue – running out of steam on the back 9' },
        { value: 'focus', label: 'Concentration – losing focus on the crucial holes' },
        { value: 'nutrition', label: 'Nutrition in general – unsure what I should be doing' },
      ],
      submitLabel: 'Secure my early bird spot',
