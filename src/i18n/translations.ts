...
export const translations = {
  nb: {
    ...
    hero: {
      ...
      earlyBirdNote: 'Begrenset tidlig tilgang · 20 % rabatt til de første 500',
    },
    ...
    products: {
      ...
      gels: [
        ...
        },
        {
          ...
          benefits: ['Stabilt blodsukker', 'Ingen trøtthet', 'Vedvarende rytme'],
        },
        {
          name: 'Back 9 Clutch',
    ...
    waitlist: {
      ...
      handicapOptions: [
        ...
        { value: '24-36', label: '24–36' },
        { value: '36-plus', label: '36 eller høyere' },
        { value: 'not-registered', label: 'Vet ikke / ikke registrert' },
      ],
      frequencyLegend: 'Hvor ofte spiller du?',
      frequencyOptions: [
        { value: 'less-than-monthly', label: 'Sjeldnere enn 1 gang i måneden' },
        { value: 'monthly', label: '1–2 ganger i måneden' },
        { value: 'once-a-week', label: '1 gang i uken' },
        { value: 'twice-a-week', label: '2–3 ganger i uken' },
        { value: '3-plus-times-a-week', label: 'Oftere enn 3 ganger i uken' },
      ],
      currentSolutionLegend: 'Bruker du sportsgeler eller ernæring på runden i dag?',
      currentSolutionOptions: [
        { value: 'sports-gels-regularly', label: 'Ja, bruker sportsgeler fast' },
        { value: 'tried-not-a-habit', label: 'Har prøvd, men ikke fast rutine' },
        { value: 'food-and-snacks', label: 'Bare mat og snacks (banan, bar etc.)' },
        { value: 'nothing', label: 'Nei, ingenting' },
      ],
      painPointLegend: 'Hva er din største ernæringsutfordring på banen?',
      painPointOptions: [
        { value: 'energy-crash-back-9', label: 'Blir sliten og mister fokus mot slutten' },
        { value: 'stomach-issues', label: 'Får magebry av vanlige sportsprodukter' },
        { value: 'bad-taste', label: 'Liker ikke smaken på det jeg har prøvd' },
        { value: 'timing-uncertainty', label: 'Vet ikke hva jeg skal ta, og når' },
        { value: 'no-issue', label: 'Ingen utfordring — alt fungerer for meg' },
      ],
      gelInterestLegend: 'Hvilket av de fire konseptene treffer deg mest?',
      gelInterestOptions: [
        { value: 'tee-off', label: 'Tee Off — fokus og rolig start' },
        { value: 'front-9-focus', label: 'Front 9 Focus — jevn energi midtveis' },
        { value: 'back-9-clutch', label: 'Back 9 Clutch — løft når kroppen svikter' },
        { value: 'finishing-putt', label: 'Finishing Putt — ro til siste putt' },
        { value: 'whole-system', label: 'Hele systemet — alle fire jobber sammen' },
        { value: 'not-sure', label: 'Usikker' },
      ],
      priceLegend: 'Hva ville du betalt for en 4-pakke (én full runde)?',
      priceOptions: [
        { value: 'under-150', label: 'Under 150 kr' },
        { value: '150-199', label: '150–199 kr' },
        { value: '200-249', label: '200–249 kr' },
        { value: '250-299', label: '250–299 kr' },
        { value: '300-or-more', label: '300 kr eller mer' },
        { value: 'not-sure', label: 'Usikker' },
      ],
      purchaseIntentLegend: 'Hvor sannsynlig er det at du kjøper ved lansering?',
      purchaseIntentOptions: [
        { value: 'very-likely', label: 'Veldig sannsynlig — kjøper i lanseringsuken' },
        { value: 'likely-if-fits', label: 'Sannsynligvis — hvis pris og smak treffer' },
        { value: 'might-after-feedback', label: 'Kanskje — vil høre andres erfaring først' },
        { value: 'only-on-discount', label: 'Bare med rabatt eller på tilbud' },
        { value: 'not-sure', label: 'Usikker' },
      ],
      attributionLegend: 'Hvordan fant du GG-Gels?',
      attributionOptions: [
        { value: 'instagram-or-facebook', label: 'Instagram eller Facebook' },
        { value: 'google-search', label: 'Google-søk' },
        { value: 'friend-or-club-recommendation', label: 'Anbefaling fra venn eller klubb' },
        { value: 'golf-magazine-podcast-or-newsletter', label: 'Golfmagasin, podcast eller nyhetsbrev' },
      ...
      openFeedbackLabel: 'Noe annet vi bør vite?',
      openFeedbackHint: 'Valgfritt',
      openFeedbackPlaceholder: 'Tanker, spørsmål eller bekymringer?',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'Det er for tidlig å sette endelig pris, men vi sikter mot et nivå som er rettferdig for et premium ernæringsprodukt – ikke billig, men heller ikke urimelig for den som tar golfen seriøst. Du vil bli varslet om prissetting og få din lanseringsrabatt.',
        },
      ],
    },
  ...
  en: {
    ...
    waitlist: {
      ...
      handicapOptions: [
        ...
        { value: '18-24', label: '18–24' },
        { value: '24-36', label: '24–36' },
        { value: '36-plus', label: '36 or higher' },
        { value: 'not-registered', label: "Don't know / not registered" },
      ],
      frequencyLegend: 'How often do you play?',
      frequencyOptions: [
        { value: 'less-than-monthly', label: 'Less than once a month' },
        { value: 'monthly', label: '1–2 times a month' },
        { value: 'once-a-week', label: 'Once a week' },
        { value: 'twice-a-week', label: '2–3 times a week' },
        { value: '3-plus-times-a-week', label: 'More than 3 times a week' },
      ],
      currentSolutionLegend: 'Do you use sports gels or nutrition on the course today?',
      currentSolutionOptions: [
        { value: 'sports-gels-regularly', label: 'Yes, I use sports gels regularly' },
        { value: 'tried-not-a-habit', label: 'Tried them, but not a habit' },
        { value: 'food-and-snacks', label: 'Just food and snacks (banana, bar etc.)' },
        { value: 'nothing', label: 'No, nothing' },
      ],
      painPointLegend: 'What is your biggest nutrition challenge on the course?',
      painPointOptions: [
        { value: 'energy-crash-back-9', label: 'Get tired and lose focus toward the end' },
        { value: 'stomach-issues', label: 'Regular sports products upset my stomach' },
        { value: 'bad-taste', label: "Don't like the taste of products I've tried" },
        { value: 'timing-uncertainty', label: "Don't know what to take, or when" },
        { value: 'no-issue', label: 'No challenge — what I do works for me' },
      ],
      gelInterestLegend: 'Which of the four concepts interests you most?',
      gelInterestOptions: [
        { value: 'tee-off', label: 'Tee Off — focus and a calm start' },
        { value: 'front-9-focus', label: 'Front 9 Focus — steady energy at the midpoint' },
        { value: 'back-9-clutch', label: "Back 9 Clutch — a lift when the body fades" },
        { value: 'finishing-putt', label: 'Finishing Putt — composure to the last hole' },
        { value: 'whole-system', label: 'The whole system — all four working together' },
        { value: 'not-sure', label: 'Not sure' },
      ],
      priceLegend: 'What would you pay for a 4-pack (one full round)?',
      priceOptions: [
        { value: 'under-150', label: 'Under 150 NOK' },
        { value: '150-199', label: '150–199 NOK' },
        { value: '200-249', label: '200–249 NOK' },
        { value: '250-299', label: '250–299 NOK' },
        { value: '300-or-more', label: '300 NOK or more' },
        { value: 'not-sure', label: 'Not sure yet' },
      ],
      purchaseIntentLegend: 'How likely are you to buy at launch?',
      purchaseIntentOptions: [
        { value: 'very-likely', label: "Very likely — I'll buy in launch week" },
        { value: 'likely-if-fits', label: 'Probably — if the price and taste are right' },
        { value: 'might-after-feedback', label: "Maybe — I'd want to hear how it works for others" },
        { value: 'only-on-discount', label: 'Only with a discount or on offer' },
        { value: 'not-sure', label: 'Not sure yet' },
      ],
      ...
      attributionOptions: [
        ...
        { value: 'friend-or-club-recommendation', label: 'Friend or club recommendation' },
        { value: 'golf-magazine-podcast-or-newsletter', label: 'Golf magazine, podcast or newsletter' },
      ...
      openFeedbackLabel: 'Anything else we should know?',
      openFeedbackHint: 'Optional',
      openFeedbackPlaceholder: "Thoughts, questions or concerns?",
