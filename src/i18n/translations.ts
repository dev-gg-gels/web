...
export const translations = {
  nb: {
    ...
    waitlist: {
      ...
      frequencyOptions: [
        { value: 'a-few-times-a-season', label: 'Noen ganger i sesongen' },
        { value: 'once-a-week', label: '1 gang per uke' },
        { value: 'twice-a-week', label: '2 ganger per uke' },
        { value: '3-plus-times-a-week', label: '3+ ganger per uke' },
      ],
      ...
      prioritiesOptions: [
        { value: 'steady-energy-and-focus', label: 'Jevn energi og fokus gjennom hele runden' },
        { value: 'good-taste', label: 'God smak' },
        { value: 'price', label: 'Pris' },
        { value: 'clean-ingredients', label: 'Rene/naturlige ingredienser' },
      ],
  ...
  en: {
    ...
    waitlist: {
      ...
      frequencyOptions: [
        { value: 'a-few-times-a-season', label: 'A few times a season' },
        { value: 'once-a-week', label: 'Once a week' },
        { value: 'twice-a-week', label: 'Twice a week' },
        { value: '3-plus-times-a-week', label: '3+ times a week' },
      ],
      ...
      prioritiesOptions: [
        { value: 'steady-energy-and-focus', label: 'Steady energy and focus through the round' },
        { value: 'good-taste', label: 'Good taste' },
        { value: 'price', label: 'Price' },
        { value: 'clean-ingredients', label: 'Clean/natural ingredients' },
      ],
